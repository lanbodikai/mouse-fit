  ...
  return (
    <div className="relative h-screen w-screen overflow-hidden bg-[#05060a] text-white">
      ...
      <div
        ...
        style={{
          background: `
            radial-gradient(120% 74% at 18% 34%, rgba(217, 70, 239, 0.3), transparent 65%),
            radial-gradient(98% 62% at 82% 56%, rgba(34, 211, 238, 0.24), transparent 72%),
            radial-gradient(130% 100% at 50% 100%, rgba(2, 6, 14, 0.98), rgba(1, 4, 12, 1) 72%)
          `,
        }}
      />
                  ...
                  {index === 0 ? (
                    <Link
                      ...
                      className={`truncate no-underline transition ${
                        isActive ? "text-white [text-shadow:0_0_14px_rgba(217,70,239,0.45)]" : "text-white/46 hover:text-white/70"
                      }`}
                    >
                      {item}
                    </Link>
                    ...
                    <span
                      className={`truncate transition ${
                        isActive ? "text-white [text-shadow:0_0_14px_rgba(217,70,239,0.45)]" : "text-white/46"
                      }`}
                    >
                      {item}
                    </span>
